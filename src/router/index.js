...
const routes = [
  ...
  {
    path: "/designbasic-lesson-menu",
    name: "DesignBasicMenuPage",
    meta: { requiresAuth: true },
    component: () => import("../components/course/course-8/DesignBasicMenuPage.vue"),
  },
  {
    path: "/designbasic-lesson-1",
    name: "DesignBasicPage1",
    meta: { requiresAuth: true },
    component: () => import("../components/course/course-8/DesignBasicPage1.vue"),
  },
  {
    path: "/designbasic-lesson-2",
    name: "DesignBasicPage2",
    meta: { requiresAuth: true },
    component: () => import("../components/course/course-8/DesignBasicPage2.vue"),
  },
  {
    path: "/designbasic-lesson-3",
    name: "DesignBasicPage3",
    meta: { requiresAuth: true },
    component: () => import("../components/course/course-8/DesignBasicPage3.vue"),
  },
  {
    path: "/my-page",
    name: "MyPage",
