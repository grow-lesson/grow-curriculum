<template>
  <div class="welcome-page">
    ...
    <div class="hero-section">
      <p class="hero-description">あなたのプログラミングスキルを向上させ、新たな知識を習得しましょう。</p>
      <section id="features" class="features-section">
        <div class="features-container">
          <div class="feature">
            ...
            <div class="feature-image">
              <div class="feature-logo">
                <img src="../../assets/images/menu/html.png" class="feature-icon" alt="html" />
              </div>
              <div class="feature-logo">
          ...
          <div class="feature">
            ...
            <a class="feature-button" @click="goToVueMenuPage">受講する</a>
          </div>
        </div>
      </section>
    </div>
...
export default {
  ...
  setup() {
    ...
    const goToVueMenuPage = () => {
      router.push({ name: "VueMenuPage" });
    };
