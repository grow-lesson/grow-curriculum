  ...
  <div>
    ...
    <div class="container">
      <div class="main-content">
        <Title title="JQuery 7" id="Title"></Title>
        <Document>
          <p>スライダーの実装について学びましょう。</p>
        </Document>
        ...
        <Document>
          ...
          <p>
            ...
            1: 初期設定と変数の定義、スライダーボタンのクリックによって移動する関数を決める設定<br>
            2: 次のスライドに移動する関数<br>
            3: 前のスライドに移動する関数<br>
            4: スライダーの位置を変更する関<br>
            <br>
            まずは、初期設定と変数の定義、スライダーボタンのクリックによって移動する関数を決める設定を行います。<br>
            (1)スライダーリスト要素を取得してください (変数名: $sliderList)<br>
            (2)スライダーアイテム要素を取得してください (変数名: $sliderItem)<br>
            (3)スライダーボタン要素を取得してください (変数名: $sliderButton)<br>
            (4)スライダーアイテムの幅を取得してください (変数名: sliderWidth)<br>
            (5)スライダーアイテムの数を取得してください (変数名: sliderNumber)<br>
            (6)スライダーの現在の位置を初期化してください (変数名: sliderPosition)<br>
            (7)スライダーボタンのクリックイベントを設定してください<br>
            (8)ボタンのデータ属性を取得してください (変数名: controlData)
            (9)次のスライドに移動する関数を定義してください (関数名: moveNext)<br>
            (10)スライダーの位置を1つ進めてください<br>
            (11)スライダーの位置を変更する関数を呼び出してください (関数名: sliderMotion)<br>
            (12)前のスライドに移動する関数を定義してください (関数名: movePrev)<br>
            (13)スライダーの位置を1つ戻してください<br>
            (14)スライダーの位置を変更する関数を呼び出してください (関数名: sliderMotion)<br>
          </p><br>
          <Terminal :fileName="jqueryData.file1.filename" :copiedText="jqueryData.file1.code" :lang="jqueryData.file1.language" />
          <p>
            <br>
            ここまでできたら次のスライドに移動する関数を定義してください<br>
            (1)スライダーの位置を1つ進めてください<br>
            (2)スライダーの位置を変更する関数を呼び出してください (関数名: sliderMotion)<br>
          </p><br>
          <Terminal :fileName="jqueryData.file2.filename" :copiedText="jqueryData.file2.code" :lang="jqueryData.file2.language" />
          <p>
            <br>
            ここまでできたら前のスライドに移動する関数を定義してください<br>
            (1)スライダーの位置を1つ戻してください<br>
            (2)スライダーの位置を1つ戻してください<br>
          </p><br>
          <Terminal :fileName="jqueryData.file3.filename" :copiedText="jqueryData.file3.code" :lang="jqueryData.file3.language" />
          <p>
            <br>
            最後にスライダーの位置を変更する関数を定義してください<br>
            (1)スライダーの位置が0未満の場合の処理を追加してください<br>
            (2)スライダーの位置が最大数を超えた場合の処理を追加してください<br>
...
import { jqueryData } from "@/data/jqueryData7.js";
