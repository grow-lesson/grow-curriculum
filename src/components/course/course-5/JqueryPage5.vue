      ...
      <div class="main-content">
        ...
        <Document>
          ...
          <p>
            ...
            1: 初期設定と変数の定義を決める、ホバーイベント設定<br>
            2: ツールチップをフェードインする関数<br>
            3: ツールチップをフェードアウトする関数<br>
            4: マウスの動きに応じてツールチップを移動する関数<br>
            5: テキストにホバーしたときのイベントを設定してください<br>
            <br>
            まずは、初期設定と変数の定義、スライダーボタンのクリックによって移動する関数を決める設定を行います。<br>
            (1)ツールチップの要素を取得してください (変数名: $tooltipBody)<br>
            (2)ツールチップを生成し、ツールチップの要素の前に挿入してください<br>
            (3)ツールチップのアイテム要素を取得してください (変数名: $tooltipItem)<br>
            (4)hoverText関数を呼び出してください<br>
          </p><br>
          <Terminal :fileName="jqueryData.file1.filename" :copiedText="jqueryData.file1.code" :lang="jqueryData.file1.language" />
          <p>
            <br>
            ここまでできたらツールチップをフェードインする関数を設定してください<br>
            (1)ツールチップをフェードインしてください<br>
          </p><br>
          <Terminal :fileName="jqueryData.file2.filename" :copiedText="jqueryData.file2.code" :lang="jqueryData.file2.language" />
          
          <p>
            <br>
            ここまでできたらツールチップをフェードアウトする関数を設定してください<br>
            (1)ツールチップをフェードアウトしてください<br>
          </p><br>
          <Terminal :fileName="jqueryData.file3.filename" :copiedText="jqueryData.file3.code" :lang="jqueryData.file3.language" /><p>
            <br>
            ここまでできたらマウスの動きに応じてツールチップを移動する関数を設定してください<br>
            (1)ツールチップの位置を更新してください<br>
          </p><br>
          <Terminal :fileName="jqueryData.file4.filename" :copiedText="jqueryData.file4.code" :lang="jqueryData.file4.language" />
          <p>
            <br>
            ここまでできたらテキストにホバーしたときのイベントを設定する関数を設定してください<br>
            (1)ツールチップの要素にマウスイベントを設定してください<br>
            (2)マウスエンター時のイベントを設定してください (関数名: fadeInDescription)<br>
            (3)マウスリーブ時のイベントを設定してください (関数名: fadeOutDescription)<br>
...
import { jqueryData } from "@/data/jqueryData5.js";
