  ...
  <div>
    ...
    <div class="container">
      <div class="main-content">
        <Title title="JQuery 4" id="Title"></Title>
        <Document>
          <p>タブメニューの実装について学びましょう。</p>
        </Document>

        <!-- section 1 -->
        <SubTitle subTitle="1. タブメニューの実装" id="subTitle1"></SubTitle>
        <Document>
          ...
          <p>
            ...
            1: 初期設定と変数の定義を決める<br>
            2: ナビゲーションアイテムのクリックイベントを設定<br>
            <br>
            まずは、初期設定と変数の定義を行います。<br>
            (1)ナビゲーションリストの要素を取得してください (変数名: $navList)<br>
            (2)ナビゲーションアイテムの要素を取得してください (変数名: $navItem)<br>
            (3)コンテンツリストの要素を取得してください (変数名: $contentsList)<br>
            (4)コンテンツアイテムの要素を取得してください (変数名: $contentsItem)<br>
          </p><br>
          <Terminal :fileName="jqueryData.file1.filename" :copiedText="jqueryData.file1.code" :lang="jqueryData.file1.language" />
          <p>
            <br>
            ここまでできたらナビゲーションアイテムのクリックイベントを設定してください<br>
            (1)クリックされたアイテムのインデックスを取得してください (変数名: item)<br>
            (2)全てのコンテンツアイテムにクラスを追加して非表示にしてください (クラス名: is-hidden)<br>
            (3)クリックされたアイテムに対応するコンテンツアイテムからクラスを削除して表示してください<br>
          </p><br>
          <Terminal :fileName="jqueryData.file2.filename" :copiedText="jqueryData.file2.code" :lang="jqueryData.file2.language" />
          <NavigationButtons
            :previousPageName="'JqueryPage3'"
            :nextPageName="'JqueryPage5'"
          />
        </Document>
...
import { jqueryData } from "@/data/jqueryData4.js";
...
export default {
  ...
  setup() {
    const sections = [
      { id: "Title", title: "JQuery 4" },
      { id: "subTitle1", title: "  1. タブメニューの実装" },
