...
export default defineComponent({
  ...
  setup() {
    ...
    const lessons = [
      { img: require("@/assets/images/menu/lesson1.png"), imgSp: require("@/assets/images/menu/lesson1-sp.png"), alt: "lesson1", text: "ターミナルの基本的な操作とコマンドの使用方法を学びます。", pageName: "CommandLinePage1" },
    ];
