  ...
  <div>
    ...
    <div class="container">
      <div class="main-content">
        <Title title="コマンドライン 1" id="Title"></Title>
        <Document>
        ...
        <Document>
          ...
          <p>
            皆さんがこれから学ぶ「コマンドライン」について概要を学んでいきましょう!<br>
          </p><br>
        ...
        <Document>
          ...
          <div>
            <img @click="openModal(imagePaths.software)" :src="imagePaths.software" class="powerpoint-image" alt="software" />
          </div><br>
          ...
          <div>
            <img @click="openModal(imagePaths.hardware)" :src="imagePaths.hardware" class="powerpoint-image" alt="hardware" />
          </div><br>
        ...
        <Document>
          ...
          <div>
            <img @click="openModal(imagePaths.step1)" :src="imagePaths.step1" class="screen-image" alt="git-bash-1" />
          </div><br>
          <p>
          ...
          <div>
            <img @click="openModal(imagePaths.tree)" :src="imagePaths.tree" class="powerpoint-image" alt="tree" />
          </div><br>
          <p>
          ...
          <div>
            <img @click="openModal(imagePaths.step2)" :src="imagePaths.step2" class="screen-image" alt="git-bash-2" />
          </div><br>
          <p>
            CUI操作ではこのようになりますが、GUI操作だとエクスプローラを開いてCドライブをクリックした時の画面という事になります。<br>
          </p><br>
          <div>
            <img @click="openModal(imagePaths.folder1)" :src="imagePaths.folder1" class="screen-image" alt="folder-1" />
          </div><br>
          <br>
          <p>
          ...
          <div>
            <img @click="openModal(imagePaths.step3)" :src="imagePaths.step3" class="screen-image" alt="git-bash-3" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.folder2)" :src="imagePaths.folder2" class="screen-image" alt="folder-2" />
          </div><br>
          <p>
          ...
          <div>
            <img @click="openModal(imagePaths.step4)" :src="imagePaths.step4" class="screen-image" alt="git-bash-4" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.folder3)" :src="imagePaths.folder3" class="screen-image" alt="folder-3" />
          </div><br>
          <p>
          ...
          <div>
            <img @click="openModal(imagePaths.memo)" :src="imagePaths.memo" class="screen-image" alt="memo" />
          </div><br>
          <p>
            ⑥<br>
            git bashに画像のように入力し、実行しましょう。<br>
          ...
          <div>
            <img @click="openModal(imagePaths.step5)" :src="imagePaths.step5" class="screen-image" alt="git-bash-5" />
          </div><br>
        </Document>
        ...
        <Document>
          ...
          <div>
            <img @click="openModal(imagePaths.step6)" :src="imagePaths.step6" class="screen-image" alt="git-bash-6" />
          </div><br>
          <p>
          ...
          <div>
            <img @click="openModal(imagePaths.step7)" :src="imagePaths.step7" class="screen-image" alt="git-bash-7" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.folder4)" :src="imagePaths.folder4" class="screen-image" alt="folder-4" />
          </div><br>
          <p>
            ⑧<br>
            git bashに画像のように入力し、実行しましょう。<br>
          ...
          <div>
            <img @click="openModal(imagePaths.step8)" :src="imagePaths.step8" class="screen-image" alt="git-bash-8" />
          </div><br>
          ...
          <div>
            <img @click="openModal(imagePaths.step9)" :src="imagePaths.step9" class="screen-image" alt="git-bash-9" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.folder5)" :src="imagePaths.folder5" class="screen-image" alt="folder-5" />
          </div><br>
          <p>
          ...
          <div>
            <img @click="openModal(imagePaths.step10)" :src="imagePaths.step10" class="screen-image" alt="git-bash-10" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.folder6)" :src="imagePaths.folder6" class="screen-image" alt="folder-6" />
          </div><br>
        </Document>
        <SectionTitle sectionTitle="2-3. プログラムの命令(複製・削除)" id="sectionTitle2-3"></SectionTitle>
        <Document>
          <p>
            最後にディレクトリやファイルの複製や削除ができるコマンドを学びましょう。<br><br>
          </p>
          ...
          <div>
            <img @click="openModal(imagePaths.step11)" :src="imagePaths.step11" class="screen-image" alt="git-bash-11" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.folder7)" :src="imagePaths.folder6" class="screen-image" alt="folder-7" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.copy)" :src="imagePaths.copy" class="screen-image" alt="copy" />
          </div><br>
          ...
          <div>
            <img @click="openModal(imagePaths.step12)" :src="imagePaths.step12" class="screen-image" alt="git-bash-12" />
          </div><br>
          <div>
            <img @click="openModal(imagePaths.folder8)" :src="imagePaths.folder8" class="screen-image" alt="folder-8" />
          </div><br>
        </Document>
...
export default {
  ...
  setup() {
    const sections = [
      ...
      { id: "sectionTitle2-1", title: "    2-1. 2-1. プログラムの命令(作成・表示・移動)②" },
