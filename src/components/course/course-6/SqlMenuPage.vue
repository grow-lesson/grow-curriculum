    ...
    <div class="lesson-container">
      <div class="lesson-title">
        <div class="breadcrumb">
          <a href="/course-menu">初級コース</a> > SQL
        </div>
        <h1 class="lesson-heading">SQL</h1>
      </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const lessons = [
      { img: require("@/assets/images/menu/lesson1.png"), imgSp: require("@/assets/images/menu/lesson1-sp.png"), alt: "lesson1", text: "SQLのコマンド基本的な操作と考え方を学びます。", pageName: "SqlPage1" },
    ];
