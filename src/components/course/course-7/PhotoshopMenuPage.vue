    ...
    <div class="lesson-container">
      <div class="lesson-title">
        <div class="breadcrumb">
          <a href="/course-menu">デザインコース</a> > Photoshop
        </div>
        <h1 class="lesson-heading">Photoshop</h1>
      </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const lessons = [
      { img: require("@/assets/images/menu/lesson1.png"), imgSp: require("@/assets/images/menu/lesson1-sp.png"), alt: "lesson1", text: "Photoshopの概要と画面の見方について学びます。", pageName: "PhotoshopPage1" },
      { img: require("@/assets/images/menu/lesson2.png"), imgSp: require("@/assets/images/menu/lesson2-sp.png"), alt: "lesson2", text: "Photoshopのツールについて学びます。", pageName: "PhotoshopPage2" },
      { img: require("@/assets/images/menu/lesson3.png"), imgSp: require("@/assets/images/menu/lesson3-sp.png"), alt: "lesson3", text: "最終課題", pageName: "PhotoshopPage3" },
    ];
